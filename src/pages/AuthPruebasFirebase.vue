    <template>
      <div class="personal">
          ...
          <div class="row">
<div class="col"> <q-btn flat  rounded color="black" disable  class="full-width"  label="Registro" /> </div>
<div class="col"> <q-btn flat  rounded color="black"  class="full-width"  label="Login" /> </div>
