...
<!-- Seccion modal del mapa -->
    ...
    <div class="row q-col-gutter-x-xs q-col-gutter-y-lg">
          <div v-for="postimg in postsimg"
                                    :key="postimg" style="margin-top:3vh;">
                                    <q-img
                                      :src="postimg.url"
                                      spinner-color="white"
      ...
      <q-item v-for="post in posts" :key="post['.actorId']" clickable v-model="diego" v-ripple>
        <q-item-section avatar>
          <q-avatar rounded>
